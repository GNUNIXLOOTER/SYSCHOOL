        ...
        <table id="dataw" class="table table-striped table-bordered table-condensed table-hover">
            ...
            while ($reg=$rspta->fetch_object()) {
                ...
                <tr>
                    ...
                    <?php
                    if($regc!=null){
                        if($regc->kind_id==1){ echo "<strong>Asistencia</stron>"; }
                        else if($regc->kind_id==2){ echo "<strong>Tarde</stron>"; }
                        else if($regc->kind_id==3){ echo "<strong>Falta</stron>"; }
                        else if($regc->kind_id==4){ echo "<strong>Permiso</stron>"; }
        ...
        <table id="dataco" class="table table-striped table-bordered table-condensed table-hover">
            ...
            while ($reg=$rspta->fetch_object()) {
                ...
                <tr>
                    ...
                    <?php
                    if($regc!=null){
                        if($regc->kind_id==1){ echo "<strong>Normal</stron>"; }
                        else if($regc->kind_id==2){ echo "<strong>Buena</stron>"; }
                        else if($regc->kind_id==3){ echo "<strong>Excelente</stron>"; }
                        else if($regc->kind_id==4){ echo "<strong>Mala</stron>"; }
                        else if($regc->kind_id==5){ echo "<strong>Muy Mala</stron>"; }
