...
public function listar_asistencia($alumn_id,$team_id,$date_at){
	...
	$sql="SELECT * FROM asistencia a INNER JOIN alumno p ON a.alumn_id=p.id INNER JOIN grupo t ON a.team_id=t.idgrupo  WHERE a.alumn_id='$alumn_id' AND a.team_id='$team_id' AND a.date_at='$date_at'";
	return ejecutarConsulta($sql);
}
  
public function listar_comportamiento($alumn_id,$team_id,$date_at){

	$sql="SELECT * FROM comportamiento a INNER JOIN alumno p ON a.alumn_id=p.id INNER JOIN grupo t ON a.team_id=t.idgrupo  WHERE a.alumn_id='$alumn_id' AND a.team_id='$team_id' AND a.date_at='$date_at'";
	return ejecutarConsulta($sql);
}
...
public function cantidadalumnos_porgrupo($user_id,$idgrupo){
	$sql="SELECT a.id as idalumno, a.name,a.lastname,a.image  FROM alumno a INNER JOIN alumno_grupo alt ON a.id=alt.alumn_id WHERE a.user_id='$user_id' AND alt.team_id='$idgrupo'";
	
	
	return ejecutarConsulta($sql); 
}
public function cantidadg($user_id,$idgrupo){
	$sql="SELECT COUNT(*) total_alumnos  FROM alumno a INNER JOIN alumno_grupo alt ON a.id=alt.alumn_id WHERE a.user_id='$user_id' AND alt.team_id='$idgrupo'";
...
public function cantidadgrupos($idusuario){
	$sql="SELECT idgrupo,nombre, idusuario, favorito FROM grupo WHERE idusuario='$idusuario'";
	return ejecutarConsulta($sql);
}
