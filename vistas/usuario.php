...
<div class="box-header with-border">
  <h1 class="box-title"><i class="fa fa-th-large"></i> <strong>Usuarios <span><i class="fa fa-arrow-right"></i></span> </strong><button class="btn btn-dropbox" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i>Registrar</button></h1>
