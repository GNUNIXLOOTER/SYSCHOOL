...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
          ...
          <div class="<?php echo $colores[array_rand($colores)]; ?> collapsed-box">
            ...
            <div class="box-body" style="">
              ...
              <div class="direct-chat-messages">
                ...
                <div class="direct-chat-msg">
                   ...
                   if (empty($reg->image)){
                    echo ' <img class="img-circle" src="../files/imagenes/anonymous.png" height="50px" width="50px">';

                  }else echo '<img class="img-circle" src="../files/imagenes/'. $reg->image.'" height="50px" width="50px">';
                     } ?>
                  <!-- /.direct-chat-info -->
                  <!-- /.direct-chat-text -->
                </div>
            ...
            <div class="box-footer" style="">
              <a href="vista_grupo.php?idgrupo=<?php echo $idgrupo; ?>" class="btn btn-dropbox form-control" >CONSULTAR<i class="fa fa-arrow-circle-right"></i></a>
            </div>
            <!-- /.box-footer-->
          </div>
          <!--/.direct-chat -->
