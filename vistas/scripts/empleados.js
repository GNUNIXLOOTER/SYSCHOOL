...
$.post("../ajax/empleados.php?op=permisos&id=", function(r){
	$("#permisos").html(r);
});
}
...
function mostrar(idusuario){
	$.post("../ajax/empleados.php?op=mostrar",{idusuario : idusuario},
	...
	$.post("../ajax/empleados.php?op=permisos&id="+idusuario, function(r){
	$("#permisos").html(r);
});
}
...
function desactivar(idusuario){
	bootbox.confirm("¿Esta seguro de desactivar este dato?", function(result){
		if (result) {
			$.post("../ajax/empleados.php?op=desactivar", {idusuario : idusuario}, function(e){
				bootbox.alert(e);
				tabla.ajax.reload();
			});
		}
...
function activar(idusuario){
	bootbox.confirm("¿Esta seguro de activar este dato?" , function(result){
		if (result) {
			$.post("../ajax/empleados.php?op=activar", {idusuario : idusuario}, function(e){
				bootbox.alert(e);
				tabla.ajax.reload();
			});
		}
