...
<div class="box-header with-border">
  <h1 class="box-title"><i class="fa fa-th-large"></i> <strong>Empleados <span><i class="fa fa-arrow-right"></i></span> </strong><button class="btn btn-dropbox" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i>Registrar</button></h1>
...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="text" name="salario" id="salario" maxlength="20" placeholder="Salario" required>
    </div>
